  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editModalLabel"> <FONT COLOR="#ff0000">Restriction Only 30 English words are allowed Edit this question</FONT></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      
      <form action="/forum/adminquestions.php" method="post">
      <div class="modal-body">
      <input  type="hidden" name="thread_idEdit" id="thread_idEdit">
  <div class="form-group">
    <label for="title">Note Title</label>
    
    <input placeholder="Name" maxlength="30" data-max-chars="30" class="input-control count-chars"  type="text"  id="thread_titleEdit" name="thread_titleEdit" aria-describedby="emailHelp">
    
</div>
  
  <div class="form-group">
    <label for="desc">Note Description</label>
    <textarea placeholder="Name" maxlength="30" data-max-chars="30"class="form-control" id="thread_descEdit" name="thread_descEdit" rows="3">
...
<div class="container my-4">
  <h1>ADMIN EDIT AND  DELETE THE QUESTIONS</h1>
...
console.log("yes");
window.location=`/forum/adminquestions.php?delete=${thread_id}`;
