...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="/forum/adminanswer.php" method="post">
  ...
  <div class="form-group">
    ...
    <textarea placeholder="Name" maxlength="30" data-max-chars="30" class="input-control count-chars"  type="text"type="text" class="form-control" id="comment_contentEdit" name="comment_contentEdit" aria-describedby="emailHelp"></textarea>
    
  </div>
  
  <div class="form-group">
    <label for="desc">comment_by</label>
    <textarea placeholder="Name" maxlength="30" data-max-chars="30" class="input-control count-chars"  type="text"type="text" class="form-control" id="comment_byEdit" name= "comment_byEdit" rows="3"></textarea>
...
<div class="container my-4">
  <h2>ADMIN CAN EDIT AND DELETE THE ANSWER</h2>
...
console.log("yes");
window.location=`/forum/adminanswer.php?delete=${comment_id}`;
